// MULTIMAP : 2 parameter ; duplicate key access i.e {18,"Hardik"}
...
int main(){
	...
	std::multimap<int,std::string> player = {{18,"Virat"},{45,"Rohit"},{7,"Dhoni"},{18,"Hardik"}}; 
	...
	std::multimap<int,std::string> player1 ;
	player1[18] = "Virat" ;	
	player1[7] = "MSD" ;	
	player1[45] = "Rohit" ;	
	...
	std::multimap<int,std::string> player2 ;
